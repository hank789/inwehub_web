<template>
  <svg class="vue-star-rating-star" :height="getSize" :width="getSize" :viewBox="viewBox"
       @click="selected">
    ...
    <polygon :points="starPointsToString" :fill="getGradId" :stroke="getBorderColor" :stroke-width="border"
