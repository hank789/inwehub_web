      ...
      <div
        ...
        <div style="width: 100%; height: 95px;  position: relative;">
          <img src="../../statics/images/balance2.png"
               style="width:69px; height: 69px; border-radius: 50%; position: absolute; left: 0; right:0; top: 0; bottom: 0; margin: auto; border: 2px solid #DBDCDB;">
        </div>
        <div
        ...
        <div style="width: 100%; height:117px;  position: relative;">
           <div style="width:220px; height: 84px;  position: absolute; left: 0; right: 0; top: 0; bottom: 0; margin: auto">
             <img src="../../statics/images/xiaoha-erweima.jpeg" style="width: 84px; height: 84px; border-radius: 10px; float: left;">
             <div style="float:right; margin-top: 21px;">
               <span style="display: block; font-size:15px; color: #ffffff;">扫描前往领取特权</span>
               <span style="display: block; font-size:12px; color: #ffffff;">（首次登陆1元提问）</span>
             </div>
           </div>
        </div>
