  ...
  <div>
    ...
    <div class="mui-content answerRichText blur">
      <div class="form form-realAnswer" v-show="!loading">
        <Meditor class="container-editor container-editor-app container-editor-add" ref="myTextEditor" v-model.trim="description" :content="description" :rows="5" :descMaxLength="50000"
