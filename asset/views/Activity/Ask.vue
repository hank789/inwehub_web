<template>
  <div>
    <div class="mui-content">
      ...
      <div class="content">
        <h5>什么是付费专业问答?</h5>
        <p>我们追求和致力营造一个高品质的专家帮助社区，通过问答解决您面临的各类SAP相关问题。所有入驻的专家有着较高的准入门槛，付费是对专家耗费时间和精力的感谢。提问的定价<b>（188元/ 88元/ 28元）</b>及更多问题，您可以点击<a @tap.stop.prevent="$router.pushPlus('/help/question')">常见问题</a>寻找答案。</p>
