<template>
  <div>
    <div class="mui-content">
      ...
      <div class="content">
        <h5>什么是付费专业问答?</h5>
        <p>我们追求和致力营造一个高品质的专家帮助社区，通过问答解决您面临的企业管理咨询和SAP相关的问题。所有入驻的专家有着较高的准入门槛，付费是对专家耗费时间和精力的感谢。提问的定价<b>（88元/ 60元/ 28元）</b>及更多问题，您可以点击<a @tap.stop.prevent="$router.pushPlus('/help/question')">常见问题</a>寻找答案。</p>

        <h5>如何提出一个好问题？</h5>
        <p>好刀要用于钢刃上，既然是专业问答服务，我们就希望您问的更专业些。我们在主页上会随时更新优质的提问，供您提问时候进行参考。为了能够快速准确的解决问题，您还需要遵守一定的<a @tap.stop.prevent="$router.pushPlus('/help/ask')">问答规范</a>。</p>
