  ...
  <div>
    ...
    <div class="mui-content absolute">
      <div class="feedback">
        ...
        <MTextarea v-model.trim="description" :content="description" :rows="9" :descMaxLength="500" :placeholder='placeholdercontent'></MTextarea>
...
<script>
  ...
  const Feedback = {
    ...
    methods: {
      ...
      getparams() {
        console.warn(this.$route.params.type);
