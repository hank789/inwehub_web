  ...
  <div>
    ...
    <div id="page_product_tags" class="mui-modal mui-pageSub">
      <div class="mui-scroll-wrapper">
        <div class="mui-scroll">
          <!--这里放置真实显示的DOM内容-->
          <industry-tags-indexed-list :tag_type="4" :selected="newItem.product_tags" :back_id="page_product_tags_id"
    ...
    <div id="account_add_job" class="mui-page mui-pageSub">
      <div class="mui-navbar-inner mui-bar mui-bar-nav">
        ...
        <a @tap.stop.prevent="addOrUpdateAccountItem('job')"
        ...
        <div class="mui-scroll-wrapper">
          <div class="mui-scroll">
            <ul class="mui-table-view">
              ...
              <li class="mui-table-view-cell">
                <div class="mui-input-row">
                  <a href="#page_industry_tags" @tap="changeIndustryTagsOwner('job')"
              ...
              <li class="mui-table-view-cell">
                <div class="mui-input-row" @tap.stop.prevent="initDate(1)">
                  <label class="mui-navigate-right">开始时间</label><label class="mui-pull-right account-setting-field"
                                                                       v-text="newItem.begin_time"
                                                                       v-if="newItem.begin_time"></label><label
              ...
              <li class="mui-table-view-cell">
                <div class="mui-input-row" @tap.stop.prevent="initDate(2)">
                  <label class="mui-navigate-right">结束时间</label><label class="mui-pull-right account-setting-field"
                                                                       v-text="newItem.end_time"
                                                                       v-if="newItem.end_time"></label><label
                  class="mui-pull-right account-setting-field emptyFields" v-else>请选择</label>
                </div>
              </li>
              <li class="mui-table-view-cell">
            ...
            <div class="deleteWrapper" v-show="newItem.id">
              <button type="button" class="mui-btn mui-btn-primary" @tap.stop.prevent="deleteAccountItem('job')">删除
      ...
      <div class="mui-page-content">
        <div class="mui-scroll-wrapper">
          <div class="mui-scroll">
            ...
            <div class="deleteWrapper" v-show="newItem.id">
              <button type="button" class="mui-btn mui-btn-primary" @tap.stop.prevent="deleteAccountItem('project')">
                删除
      ...
      <div class="mui-page-content">
        <div class="mui-scroll-wrapper">
          <div class="mui-scroll">
            ...
            <div class="deleteWrapper" v-show="newItem.id">
              <button type="button" class="mui-btn mui-btn-primary" @tap.stop.prevent="deleteAccountItem('edu')">删除
      ...
      <div class="mui-page-content">
        <div class="mui-scroll-wrapper">
          <div class="mui-scroll">
            ...
            <div class="deleteWrapper" v-show="newItem.id">
              <button type="button" class="mui-btn mui-btn-primary" @tap.stop.prevent="deleteAccountItem('train')">删除
