		...
		<div class="mui-content">
			<ul class="mui-table-view">
				...
				<li class="mui-table-view-cell mui-input-row">
					<div @tap.stop.prevent="selectMajor" class="mui-navigate-right"><label>学历</label><label class="mui-pull-right account-setting-field">{{edu.degree?edu.degree:'请选择'}}</label></div>
				</li>
